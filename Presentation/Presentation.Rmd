...
ggplot(rockfish_data_added_genus, aes(x=sal_surf)) +
   geom_histogram(fill="blue", alpha = 0.3, bins = 50) +
   labs(x = "Salinity") +
  geom_histogram(aes(x=temp_surf), fill="red", alpha = 0.3, bins = 50)+
  geom_histogram(aes(x=oxygen_surf), fill="green", alpha = 0.3, bins = 50)
```

## Check Out Some Fishies 


![thank you](https://media.giphy.com/media/ZTAojHK9IHsSQ/giphy.gif)
