...
![rockfish](https://caseagrant.ucsd.edu/sites/default/files/Vermilion-Rockfish-king.jpg) 
...
## Layered Histogram of Accumulation of Rockfish Species by Surface Temp and Temp at 100 meters
```{r}
ggplot(rockfish_data_added_genus, aes(x=temp_surf)) +
   geom_histogram(fill="blue", alpha = 0.3, bins = 50) +
   labs(x = "Temp (C)") +
...
An interesting point is that abundances are the same in areas, even though temperatures are different. 
